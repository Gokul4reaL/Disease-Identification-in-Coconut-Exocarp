...
import 'package:ooppddd/NewScreen1.dart';
import 'package:ooppddd/NewScreen2.dart';
import 'package:ooppddd/NewScreen3.dart';
import 'package:ooppddd/NewScreen4.dart';
import 'package:ooppddd/NewScreen5.dart';
              ...
              ElevatedButton(
                ...
                onPressed:() {
                  ...
                  if (val == 3) {
                    ...
                    Navigator.push(
                        context, MaterialPageRoute(builder: (context) => NewScreen4()));
                  }
                  if (val == 4) {
                    Navigator.push(
                        context, MaterialPageRoute(builder: (context) => NewScreen5()));
                  }
