                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      const Text(
                        '* Apply urea 1 kg, super phosphate 1.5 kg, and muriate of potash @ 2.5 kg/palm/year. Increased quantity is recommended to increase the plants resistance to the mite.',
                      ...
                      //Text
                      const Text(
                        '* Soil application of micronutrients like Borax 50 g + gypsum 1.0kg + Manganese sulphate 0.5 kg/palm/ year TNAU Micronutrient solution 200 ml/tree.',
                        style: TextStyle(
                          fontSize: 15,
                          color: Colors.green,
                        ), //Textstyle
